...
| `duplicate-policies` | info | — | Same algorithm as legacy duplicate detection: identical action + target signature, or duplicate names. Excludes implicit and “Installed by:” companion policies. |
